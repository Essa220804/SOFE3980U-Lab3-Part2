...
## Objective   
1. Get I AM MAKING A TEST CHANGE RIGHT HERE with Jenkins.
2. Understand the pipeline syntax used by Jenkins. MAKING A TEST CHANGE
3. Configure a continuous integration pipeline for a Jenkins job. 
4. Configure a continuous ANOTHER TEST CHANGE HERE deployment pipeline for a Jenkins job.
## Repository:   
...
2. Install Jenkins Server on GCP, using Helm. Helm is a tool that creates customized applications within Kubernetes.
   ...
   2. If there is no Kubernetes cluster within your GCP project, Create a cluster as illustrated in [Lab 3 Part 1](https://github.com/zubxxr/SOFE3980U-Lab3-Part1#setup-google-kubernetes-engine-gke). To get the clusterMAKING ABOTHUADUDIUDNIU information.
      ```cmd
      kubectl cluster-info 
      ``` MAKING ANOTHE RHCAHF E
